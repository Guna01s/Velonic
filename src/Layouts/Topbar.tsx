...
import profilePic from '@/assets/images/users/user.png'
...
const Topbar = ({ toggleMenu, navOpen }: TopbarProps) => {
	...
	console.log('retrived name,:', name)
	...
	const fetchName = async () => {
		try {
			...
			setName(response[1].name)
			console.log('response from backend:', response[1].name)

			// await AsyncLocalStorage.setItem('user', response.name)
			// await AsyncLocalStorage.setItem('userId', JSON.stringify(response.id))
			...
			<div className="navbar-custom">
				<div className="topbar container-fluid">
					...
					<ul className="topbar-menu d-flex align-items-center gap-3">
						<li className="dropdown d-lg-none">{/* <SearchDropDown /> */}</li>
